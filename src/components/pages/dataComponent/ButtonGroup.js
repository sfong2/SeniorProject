  ...
  render(){
    ...
    return(
      <div className="row">
          ...
          <button type="button" disabled={dataStatus || this.props.dataTableStatus} className="btn btn-info" style={divStyle} onClick={this.props.onClickColBtn}>{this.props.colBtnCaption} Col Setting</button>
          <button type="button" disabled={dataStatus || this.props.dataTableStatus} className="btn btn-success" style={divStyle} onClick={this.props.onClickFilterBtn}>Reset Filtered</button>
